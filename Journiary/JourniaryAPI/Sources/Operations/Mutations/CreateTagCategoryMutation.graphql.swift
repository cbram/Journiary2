...
public class CreateTagCategoryMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation CreateTagCategory($input: TagCategoryInput!) { createTagCategory(input: $input) { __typename id name displayName emoji color isSystemCategory sortOrder isExpanded createdAt updatedAt } }"#
    ))

  public var input: TagCategoryInput

  public init(input: TagCategoryInput) {
    self.input = input
  }
  ...
  public struct Data: JourniaryAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("createTagCategory", CreateTagCategory.self, arguments: ["input": .variable("input")]),
    ] }
    ...
    public struct CreateTagCategory: JourniaryAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
